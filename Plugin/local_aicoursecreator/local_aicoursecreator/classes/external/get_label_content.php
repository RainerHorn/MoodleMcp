...
class get_label_content extends external_api {

    public static function execute_parameters(): external_function_parameters {
        return new external_function_parameters([
            'cmid' => new external_value(PARAM_INT, 'Course module ID of the Label activity'),
        ]);
    }
    ...
    public static function execute(int $cmid): array {
        ...
        return [
            ...
            'contentformat' => (int) $label->introformat,
            'content' => $label->intro,
        ];
    }
    ...
    public static function execute_returns(): external_single_structure {
        return new external_single_structure([
            ...
            'content' => new external_value(PARAM_RAW, 'Raw stored Label HTML content'),
        ]);
    }
}
